...
#define DISPLAY_MIRROR_Y false
#define DISPLAY_SWAP_XY false
#define DISPLAY_INVERT_COLOR    false  // Set to false if text/background look like a photo negative
#define DISPLAY_RGB_ORDER  LCD_RGB_ELEMENT_ORDER_BGR // Force base RGB channel order
#define DISPLAY_OFFSET_X  0
#define DISPLAY_OFFSET_Y  0
#define DISPLAY_BACKLIGHT_OUTPUT_INVERT false
#define DISPLAY_SPI_MODE 0
...
// ====================================================================
// ADD THIS BLOCK AT THE VERY BOTTOM OF THE FILE (RIGHT BEFORE THE LAST #endif)
// ====================================================================
